...
<div class="nera-page-header" style="display: flex; align-items: center; justify-content: center; height: 120px; text-align: center; background: #0D1232;">
    ...
    <div style="position: absolute; display: flex; align-items: center; justify-content: center; width: 100%; height: 100%; z-index: 100; background: linear-gradient(180deg, transparent, #172057 99%);">
            ...
            <div class="nera-profile-content">
                <div class="nera-profile-card" style="border: 2px solid #49DEFF; margin-bottom: 15px;">
                    ...
                    <div class="mb-3">
                        ...
                        <div style="font-size: 14px; margin-top: 10px; display: none;" id="profile_updatepassword_alerts">
                    ...
                    <button id="update_settings" style="display: inline-block; width: auto; padding: 5px 30px; margin-top: 15px; font-size: 18px; background: transparent; border: 2px solid #49DEFF;" class="nera-modal-button" id="modal_open_create">
                        Edit
                    </button>
                </div>
                ...
                if ($unset_password) { ?>
                    <div class="nera-profile-card" style="border: 2px solid #49DEFF; margin-bottom: 15px;">
                        ...
                        <button id="update_password" style="display: inline-block; width: auto; padding: 5px 30px; margin-top: 15px; font-size: 18px; background: transparent; border: 2px solid #49DEFF;" class="nera-modal-button" id="modal_open_create">
                            Create Password
                        </button>
                    </div>
                <?php } ?>
                ...
                <div class="nera-profile-topmenu">
                    <a href="/lol-boosting" class="nera-profile-neworder">
                        <div class="circle">
                            <img src="/template/img/profile-plus.svg">
                        </div>
                        NEW ORDER
                    </a>
